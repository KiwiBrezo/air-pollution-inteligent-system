...
def quality_check():
    ...
    report.save_html(os.path.join(file_location, "../reports/data_report/index.html"))
    ...
    tests.save_html(os.path.join(file_location, "../reports/data_stability/index.html"))
