...
Usage:
- Run this file: `python great_expectations/uncommitted/run_air_pollution_first_checkpoint.py`.
...
#data_context: FileDataContext = get_context(context_root_dir="../great_expectations")
data_context: FileDataContext = get_context(context_root_dir=os.path.join(os.path.dirname(__file__), "../great_expectations"))

result: CheckpointResult = data_context.run_checkpoint(
    checkpoint_name="air_pollution_first_checkpoint",
    batch_request=None,
    run_name=None,
)
